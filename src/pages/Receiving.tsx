...
export default function Receiving() {
  ...
  // Receiving can go into any warehouse EXCEPT Floor
  const receivableWarehouses = warehouses?.filter(
    (w: any) => w.warehouse_name?.toLowerCase() !== "floor"
  ) ?? [];
  ...
  // Filter history to IN movements only
      ...
      <div className="flex items-center justify-between gap-3 mb-2">
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Receive stock into any warehouse except Floor.
          </p>
        </div>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div>
                ...
                <Select value={warehouseId} onValueChange={setWarehouseId}>
                  ...
                  <SelectContent>
                    {receivableWarehouses.map((w: any) => (
